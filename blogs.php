			...
			<div class="fluid">
				...
				<div class="widget leftcontent grid12">
					<div class="widget-header">
						<h3 class="widget-title">Blogs of <?php echo $name;?> </h3>
				...
				<div class="widget-header" style="cursor:pointer;border-bottom:2px solid rgba(0, 0, 0, 0.1);border-right:2px solid rgba(0, 0, 0, 0.1);">
							<h3 class="widget-title"><span class="lr"><a href='createblog.php'>Create New Blog</a></span></h3>
						</div>
					...
					/* Get blogs of the profileid*/
					
					
					
					
					$result = mysql_query("select * from blog where authorid ='$profileid'");
					...
					/* Get the titles and blog id of the blogs of profileid */
					...
					echo "<div class='comment'>  <!-- print message received -->
						...
						<a href='blog.php?blogid=$blogid'>
						<div class='c-name'>$title	</div></a>
